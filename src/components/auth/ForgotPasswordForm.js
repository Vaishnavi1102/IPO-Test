  ...
  const handleSubmit = (e) => {
    ...
    return (    
      ...
      <AuthLayout
       ...
       subtitle="We have sent you a password reset link to your email address."
        >
        <div className="text-center">
          <div className="mx-auto flex items-center justify-center h-12 w-12 rounded-full bg-gree-100 mb-4">
